...
>
  ...
  >
    <a href="/">
      <span class="sr-only">Cécile Langlois</span>
      <img
  ...
  >
    <div class="max-w-lg">
      <p class="text-base font-semibold leading-8 text-green-600">{$page.status}</p>
      <h1 class="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">
        {$page.error?.message}
      </h1>
      <div class="mt-10">
        <a href="/" class="text-sm font-semibold leading-7 text-green-600">
